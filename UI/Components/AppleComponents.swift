...
enum BadgeStyle {
    ...
    var textColor: Color {
        ...
        case .gold: return Color.bloomWarning
            ...
            ForEach(options, id: \.self) { option in
                Button {
                    ...
                    Text(option)
                        ...
                        .foregroundStyle(selection == option ? Color.bloomPrimary : Color.bloomTextSecondary)
